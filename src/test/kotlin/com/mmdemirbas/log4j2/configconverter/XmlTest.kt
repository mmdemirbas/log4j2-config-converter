...
object XmlTest {
    private val sampleResourceName = "/com/mmdemirbas/log4j2/configconverter/sample.xml"
    ...
    @Test
    fun read() = Xml.assertReadResult(sampleResourceName, sampleConfig)

    @Test
    fun write() = Xml.assertReadWriteGivesSameResult(sampleResourceName)
}
